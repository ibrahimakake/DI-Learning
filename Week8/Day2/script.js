...
// the sent data will appear in the developer tool (network)
...
const marioGame = {
  ...
  const convertedObject = JSON.stringify(marioGame)
  console.log(convertedObject)
  // The nested objects will also be converted 

// Convert and pretty print JS object to JSON string
const jsonMarioGamePretty = JSON.stringify(marioGame, null, 2);

// Add a breakpoint to inspect values in debugger
debugger;
